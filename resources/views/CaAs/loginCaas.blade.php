...
>
    ...
    <div 
     ...
     <div class="absolute bottom-0 -z-10">
        <img src="{{ asset('images/Lower Shine.png') }}" alt="upper wall" class="w-full h-auto">
    </div>
    <div class="absolute top-0 -z-10">
        <img src="{{ asset('images/Upper Shine.png') }}" alt="upper wall" class="w-full h-auto ">
    </div>
    <!-- Upper Image -->
    <div class="absolute bottom-0 -z-10">
        <img src="images/Upper.png" alt="upper wall" class="w-full h-auto">
    </div>
    <div class="absolute top-0 -z-10">
        <img src="{{ asset('images/Upper.png') }}" alt="upper wall" class="w-full h-auto scale-y-[-1]">
    </div>
